...
let clientes2 = ["Carlos", "Ana", "Gabriel", "Joao", "Maria"];
...
//Busca linear com estruturas de dados

function buscaLinear(array,valor){
for(let i=0; i < array.lenght;i++){
    if(array[i]=== valor){
    return i;//retorna a posião do elemento encontrado
    }

}
return -1;//Retorna  o padão  -1 ao não encontrar o elemento
}
